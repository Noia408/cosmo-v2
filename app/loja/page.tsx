    ...
    <>
      <div className='w-full h-fit border-b-[0.3vw] border-gray-900 flex flex-col gap-[2vw] py-[3.5vw]'>
        ...
        <div className='w-full h-fit flex flex-col gap-[0.5vw] px-[8vw]'>
          <div>
            <h1 className='text-[3vw] font-bold'>Nossa <span className=' text-shadow-neongreen text-shadow-lg'> Loja</span></h1>
            <span className='text-[1vw] font-semibold text-darkgreen'>Volumes físicos, conteúdo digital e merchandising exclusivo</span>
          </div>
