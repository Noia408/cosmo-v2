            ...
            <div className='w-full h-full flex items-center justify-center relative '>
                ...
                <div className="w-full h-full absolute z-50 flex items-center justify-center gradient-banner">
                    <div className="w-full h-full flex flex-col items-center bg-black/60 justify-center">
                        <h1 className="text-[3vw] font-bold text-white">Bem-vindo ao <span className="text-shadow-neongreen text-shadow-lg">COSMO COMICKON</span></h1>
                        ...
                        <div className="w-full h-fit flex items-center justify-center gap-[1vw] mt-[1vw]">
                            <Link href={""} className="px-[1vw] text-black py-[0.5vw] bg-neongreen hover:bg-neongreen/70 shadow-neongreen shadow-lg duration-150 font-semibold rounded-xl">Explorar Biblioteca</Link>
